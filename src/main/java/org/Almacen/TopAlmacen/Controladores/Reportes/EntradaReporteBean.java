...
public class EntradaReporteBean implements Serializable {
    ...
    public void generarPDF() {
        try {
            ...
            if (logoEmpresa != null && reporteEntrada != null) {
                ...
                registro.setId(idParam);
                registro.setFingreso("03/04/2024");
    ...
    public static class RegistrosEntrada {
        ...
        public String getFingreso() { return fingreso; }
        public void setFingreso(String fingreso) { this.fingreso = fingreso; }
