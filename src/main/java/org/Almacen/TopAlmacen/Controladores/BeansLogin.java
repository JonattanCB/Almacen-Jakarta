...
public class BeansLogin implements Serializable {
    ...
    public void init() {
        ...
        itemMenu = DefaultMenuItem.builder().value("Requerimiento ").icon("pi pi-home").url(contextPath + "/protegido/Salidas/Requerimientos.xhtml").update("contenido_escritorio-update").build();
        firstSubmenu.getElements().add(itemMenu);
        ...
        itemMenu = DefaultMenuItem.builder().value("Validar Requermiento").icon("pi pi-home").url(contextPath+"/protegido/Salidas/RequerimientosValidacion.xhtml").update("contenido_escritorio-update").build();
        firstSubmenu.getElements().add(itemMenu);
